...
public class PaymentController {
    ...
    public ResponseEntity<PaymentLinkResponse> createPaymentLink(@PathVariable String orderId) throws ExecutionControl.UserException, RazorpayException {
        ...
        User user=userRepository.findByUserId(order.getUserId()).orElseThrow(() -> new UsernameNotFoundException("user Not not found"));
...
//
            ...
            customer.put("contact",order.getAddress().getPhone());
