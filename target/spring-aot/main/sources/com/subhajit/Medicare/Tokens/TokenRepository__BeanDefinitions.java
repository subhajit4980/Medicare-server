...
public class TokenRepository__BeanDefinitions {
   ...
   */
  private static BeanInstanceSupplier<MongoRepositoryFactoryBean> getTokenRepositoryInstanceSupplier(
      ) {
  ...
  public static BeanDefinition getTokenRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(MongoRepositoryFactoryBean.class, TokenRepository.class, Object.class, Object.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.subhajit.Medicare.Tokens.TokenRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("mongodb.TokenRepository.fragments#0"));
